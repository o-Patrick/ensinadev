...
<html lang="pt-BR">
	<head>
		...
		<title>Alterar usuário &vert; EnsinaDev</title>
	</head>
	<body>
		...
		<main class="containerFlex">
			<section class="componenteCentral">
				<h1 class="titulo titulo1">Alterar usuário</h1>
				<form action="../../../assets/funcoes/acesso/alterar/alterar-usuario.php" method="post">
					<div class="frmCampo">
