...
<html lang="pt-BR">
	<head>
		...
		<title>Alterar e-mail &vert; EnsinaDev</title>
	</head>
	<body>
		...
		<main class="containerFlex">
			<section class="componenteCentral">
				<h1 class="titulo titulo1">Alterar e-mail</h1>
				<form action="../../../assets/funcoes/acesso/alterar/alterar-email.php" method="post">
					<div class="frmCampo">
						<label for="email">E-mail</label>
						<input type="text" name="email" class="frmEmail" id="email" maxlength="80" tabindex="1" required>
					</div>
					<button type="submit" name="btnSubmit" class="btnSubmit" id="btnSubmit" tabindex="2">Alterar</button>
				</form>
			</section>
		</main>
